...
export default function BiancoRitual() {
  ...
  return (
    <section 
      ref={containerRef}
      className="bg-zinc-100 py-40 px-6 md:px-20 relative z-20 overflow-hidden"
    >
      
      {/* Background Graphic Element */}
      <div className="absolute top-0 right-0 opacity-[0.03] pointer-events-none translate-x-1/4 -translate-y-1/4 scale-150">
      ...
      <div className="max-w-6xl mx-auto flex flex-col items-center gap-20">
        ...
        >
          ...
          <p className="text-noir font-body text-lg md:text-2xl max-w-4xl mx-auto leading-relaxed uppercase tracking-widest italic pt-8 border-t border-noir/10">
            &quot;Ispirato alla storia, amato per il gusto.&quot; <br/>
            Un rituale di freschezza assoluta. Servire liscio per apprezzarne la purezza, come correttore del caff&egrave;, o diluito in acqua ghiacciata per un ristoro estivo senza tempo. 
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          className="absolute bottom-[-50px] right-0 z-20 pointer-events-none"
        >
          <img 
            src="/images/products/bianco.png" 
            alt="Villacidro Bianco Murgia" 
            className="h-[50vh] md:h-[65vh] w-auto drop-shadow-[-40px_0_100px_rgba(0,0,0,0.6)]" 
          />
        </motion.div>
        ...
        >
          ...
          >
            <span className="relative z-10 font-bold">Aggiungi al Carrello &mdash; &euro;{(21 * quantity).toFixed(2)}</span>
