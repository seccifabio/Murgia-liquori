    ...
    >
      ...
      <div className="max-w-6xl mx-auto flex flex-col items-center gap-20">
        ...
        <motion.div
          ...
          className="absolute bottom-[-60px] right-0 z-20 pointer-events-none hidden md:block"
        >
          <img 
        ...
        >
          ...
          >
            <span className="relative z-10 transition-colors duration-500 group-hover:text-black font-bold">Aggiungi al carrello &mdash; &euro;{(36 * quantity).toFixed(2)}</span>
