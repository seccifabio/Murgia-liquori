      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            <button 
              onClick={onClose}
              className="absolute top-[84px] md:top-8 right-8 z-50 p-4 rounded-full bg-black md:bg-white/5 border border-white/10 hover:bg-primary hover:text-noir transition-all duration-500 group shadow-2xl"
            >
